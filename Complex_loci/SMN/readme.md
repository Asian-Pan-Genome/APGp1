...
The **SMN** locus is one of the most complex regions in the human genome due to large-scale segmental duplications and recurrent inversions. We have decomposed this region into eight principal genomic blocks (B1 to B8), defined as the fundamental *minimizer repeat units*. These units were identified through exhaustive pairwise sequence alignments across diverse SMN haplotypes and non-human primate homologs.

The decomposition strategy presented here involves manual curation and is not a fully automated pipeline.

For researchers looking to perform similar analyses on highly repetitive or duplicated loci, we recommend similar workflows like:
...
![CHM13 self-alignment](https://github.com/Asian-Pan-Genome/APGp1/blob/main/Complex_loci/SMN/SMN_chm13.png)
